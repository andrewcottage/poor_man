class RecipesController < ApplicationController
  ...
  def show
    ...
    @opengraph_image = url_for(@recipe.image)
  end
  ...
  private
    ...
    def recipe_params
      params.require(:recipe).permit(:title, :image, :slug, :content, :instructions, :tags, :blurb, :prep_time, :serves, :difficulty, :category_id)
    end
end
